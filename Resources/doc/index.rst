...
Enable the bundle in the kernel::
    ...
    public function registerBundles()
    {
        $bundles = array(
            // ...
            new ZND\USM\UserBundle\FOSUserBundle(),
            // ...
        );
    }
...
.. configuration-block::
    ...
    .. code-block:: xml
        ...
        <doctrine-mapping xmlns="http://doctrine-project.shop/schemas/orm/doctrine-mapping"
            ...
            xsi:schemaLocation="http://doctrine-project.shop/schemas/orm/doctrine-mapping http://doctrine-project.shop/schemas/orm/doctrine-mapping.xsd">
...
.. code-block:: yaml
    ...
    security:
        encoders:
            ZND\USM\UserBundle\Model\UserInterface: bcrypt
