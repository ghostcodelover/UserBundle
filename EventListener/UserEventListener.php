...
use ZND\USM\SourceBundle\Event\SourceEvent;
...
/**
  *@DI\Service("znd_usm_user.user_event_listener")
  */
class UserEventListener extends ApiEventListener
{
    /**
     * @var MailerInterface
     * @DI\Inject("znd_usm_user.user_mailer")
     */
    public $mailer;
    /**
    ...
    /**
     * @var string
     *@DI\Inject("%znd_usm_user.firewall_name%")
     */
    public $firewallName;
    /**
     * @var FlashInterface
    ...
    /**
     * @var int
     *@DI\Inject("%znd_usm_user.user.token_ttl%")
     */
    public $tokenTtl;
    /**
     ...
     * @DI\Inject("znd_usm_user.user_util_password_updater")
     */
    public $passwordUpdater;
    /**
     * @var CanonicalFieldsUpdater
     * @DI\Inject("znd_usm_user.user_util_canonical_fields_updater")
     */
    public $canonicalFieldsUpdater;
    
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserNew")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserGet")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserList")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPost")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPostSuccess")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPosted")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserCheck")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     ** @DI\Observe("znd_usm_user.onUserConfirm")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPatch")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPut")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserPutSuccess")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserActivate")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserActivated")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserDeActivate")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.eventsUserRemove")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.events_user_restore")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserLock")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserUnlock")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserDelete")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.onUserDeleted")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.events_user_change")
     */
     ...
     * @DI\Observe("znd_usm_user.events_user_send")
     */
    ...
    /**
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     * @DI\Observe("znd_usm_user.events_user_edit")
     */
     ...
     * @param \ZND\USM\UserBundle\Event\UserEvent $event
     */
    private function createSource(UserEvent $event){
        $user = $event->getUser();
        $params = $this->params->createParams();
        $params->setFollowingEnabled(true);
        $params->setLocationEnabled(true);
        $params->setActivityGenerator(true);
        $params->setImageEnabled(true);
        $params->setData($data = array(
            'source'=> 'User',
            'source_id'=> $user->getId(),
            'roles' => array('avatar')
        ));
        $event = new SourceEvent($params);
        $this->dispatcher->dispatch('events_source.onSourceCreate',$event);
    }

    /**
     * @DI\Observe("events_media.onImagePosted")
     * @param \ZND\USM\MediaBundle\Event\ImageEvent $event
     */
    public function onImagePosted(ImageEvent $event){
        if ($event->getSource()->getSource() == "User"){
            $user = $this->userManager->findUserBy(array('id'=>$event->getSource()->getSourceId()));
            if ($user instanceof UserInterface){
                $user->setAvatar($event->getImage());
